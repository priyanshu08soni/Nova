    ...
    <div className="relative h-[250vh]">
      ...
      <section className="relative h-screen w-full overflow-hidden">
        ...
        <motion.img
          src={mountain1}
          alt="Mountains"
          className="fixed bottom-0 right-60 w-full h-auto object-cover z-[2] will-change-transform"
          style={{ y: mountain1Y, x: mountain1X }}
        />
        <motion.img
          src={mountain2}
          alt="Mountains"
          className="fixed bottom-0 left-60 w-full h-auto object-cover z-[3] will-change-transform"
      ...
      <div className="relative z-0 flex flex-col items-center justify-center text-white text-center">
        ...
        >
          <h1
            className="text-7xl md:text-8xl drop-shadow-2xl mb-6 text-balance 
        ...
        >
          <h1
            className="text-6xl md:text-7xl drop-shadow-2xl mb-6 mt-40 text-balance
               bg-gradient-to-r from-white via-orange-400 to-purple-600 
               bg-clip-text text-transparent"
          >
          ...
          <h1
            className="text-6xl md:text-7xl drop-shadow-2xl mt-6 mb-16 text-balance
               bg-gradient-to-r from-white via-orange-400 to-purple-600 
               bg-clip-text text-transparent"
          >
