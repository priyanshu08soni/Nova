  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="fixed inset-0 z-[-1] opacity-25">
        <img
          src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/sky-XKbGULCNtYhzDpVplSucACMBKrQHKf.png"
          alt="Sky background"
          className="absolute inset-0 w-full h-full object-cover"
        />
        <img
          src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/mountain2-P8eoaQlwIwOUgMhEv75xWapVXAM3oi.png"
          alt="Mountains"
          className="absolute bottom-0 left-0 w-full h-auto object-cover opacity-60"
        />
        <img
          src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/trees1-1LBL8UArWCH4qNdbbLglwB2fQju5tM.png"
          alt="Trees"
          className="absolute bottom-0 left-0 w-full h-auto object-cover opacity-40"
        />
        <div className="absolute inset-0 bg-gradient-to-b from-orange-900/20 via-pink-900/10 to-purple-900/30" />
      </div>
      ...
      <section className="relative h-screen w-full overflow-hidden">
        ...
        />
        <motion.img
          src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/sun-b6E0Gphx54WaPTaPatj4mZo8QWytCw.png"
          alt="Sun"
        ...
        />
        <motion.img
          src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/mountain1-lByZN8chvtJQtxMQnqOF0nVVTKFYjx.png"
          alt="Mountains"
        ...
        />
        <motion.img
          src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/trees2-7i5T8vSiS9r60Or7NrxzIj0nbzNyAl.png"
          alt="Trees"
      ...
      <section ref={cardsRef} style={{ height: `300vh` }} className="relative">
